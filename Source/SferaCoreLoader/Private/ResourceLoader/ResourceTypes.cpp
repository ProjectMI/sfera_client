...
std::string_view ToString(EResourceKind kind)
{
    ...
    case EResourceKind::Material: return "Material";
    case EResourceKind::Landscape: return "Landscape";
    case EResourceKind::Script: return "Script";
    case EResourceKind::Sound: return "Sound";
    case EResourceKind::Binary: return "Binary";
