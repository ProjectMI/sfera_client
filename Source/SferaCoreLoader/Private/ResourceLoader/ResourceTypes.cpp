...
const char* ToString(EResourceKind kind) {
    switch (kind) { case EResourceKind::Config: return "Config"; case EResourceKind::Mbc: return "MBC"; case EResourceKind::Texture: return "Texture"; case EResourceKind::Model: return "Model"; case EResourceKind::Material: return "Material"; case EResourceKind::Landscape: return "Landscape"; case EResourceKind::Script: return "Script"; case EResourceKind::Sound: return "Sound"; case EResourceKind::Binary: return "Binary"; default: return "Unknown"; }
}
