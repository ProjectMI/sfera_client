...
namespace Sfera {
struct FDdsImage { int32 Width = 0; int32 Height = 0; int32 Stride = 0; bool HasAlpha = false; FByteArray BgraPixels; explicit operator bool() const { return Width > 0 && Height > 0 && !BgraPixels.empty(); } };
